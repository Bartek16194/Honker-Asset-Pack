GT_t.CH_t.PT91 = {
    life = 22,
    mass = 42000,               -- Masa czołgu: 42 tony
    length = 9.23,
    width = 3.41,
    max_road_velocity = 19.4,   -- Maksymalna prędkość na drodze: 70 km/h (19.4 m/s)
    max_slope = 0.49,           -- Maksymalne nachylenie terenu: ~30% (~17°)
    fordingDepth = 1.4,         -- Maksymalna głębokość brodzenia: 1.4 m
    engine_power = 850,         -- Moc silnika: 850 KM (627 kW)
    engineMinRPM = 600,
    engineMaxPowerRPM = 2000,
    engineMaxRPM = 2600,
    engineMOI = 4.0,
    turbine = false,            -- Czołg nie ma silnika turbinowego
    ...
    max_acceleration = 3.4,     -- Maksymalne przyspieszenie: 3.4 m/s²
    min_turn_radius = 2.8,      -- Minimalny promień skrętu: ~2.8 m
    X_gear_1 = 2.48,            -- Pozycja koła przedniego (X)
    Y_gear_1 = 0,              -- Pozycja koła przedniego (Y)
    Z_gear_1 = 1.27,           -- Pozycja koła przedniego (Z)
    X_gear_2 = -2.39,          -- Pozycja koła tylnego (X)
    Y_gear_2 = 0,              -- Pozycja koła tylnego (Y)
    Z_gear_2 = -1.27,          -- Pozycja koła tylnego (Z)
    gear_type = GT_t.GEAR_TYPES.TRACKS, -- Typ napędu: gąsienice
    r_max = 0.35,              -- Maksymalny promień koła: 0.35 m
    r_track = 0.35,            -- Promień gąsienicy: 0.35 m
    armour_thickness = 0.10,   -- Grubość pancerza: ~100 mm
}
