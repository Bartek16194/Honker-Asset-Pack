...
set_recursive_metatable(GT.chassis, GT_t.CH_t.Tumak2WKM);

GT.visual.shape = "tumak2_WKM";
GT.visual.shape_dstr = "tumak2_WKM-dest";
...
GT.Name = "Tumak 2 WKM";
GT.DisplayName = _('Scout Tumak 2 WKM');
GT.DisplayNameShort = _('Scout Tumak 2 WKM');
GT.Rate = 5;
