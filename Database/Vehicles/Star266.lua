GT_t.CH_t.star266 = {
    life = 3,
    mass = 13000,               -- Zaktualizowana masa na 13000 kg
    length = 9.1,
    width = 2.5,
    max_road_velocity = 20.83,   -- Maksymalna prędkość na drodze: 75 km/h (20.83 m/s)
    max_slope = 0.25,            -- Maksymalne nachylenie terenu: około 25% (~14°)
    engine_power = 150,          -- Moc silnika: 150 KM (110 kW)
    engineMinRPM = 600,
...
set_recursive_metatable(GT.chassis, GT_t.CH_t.star266);

GT.visual.shape = "star266"
GT.visual.shape_dstr = "star266-dest"
...
GT.Name = "star266"
GT.DisplayName = _("Truck Star 266")
GT.DisplayNameShort = _('Star 266');
GT.Rate = 10
