GT_t.CH_t.Rosomak = {
    life = 10,                  -- Wytrzymałość pojazdu
    mass = 22500,               -- Masa pojazdu: 22 500 kg
    length = 7.8,               -- Długość pojazdu: 7,8 m
    width = 2.8,                -- Szerokość pojazdu: 2,8 m
    height = 3.3,               -- Wysokość pojazdu: 3,3 m
    max_road_velocity = 27.78,  -- Maksymalna prędkość na drodze: 100 km/h (27,78 m/s)
    max_slope = 0.5,            -- Maksymalne nachylenie terenu: 30° (0,5 radiana)
    fordingDepth = 1.5,         -- Głębokość brodzenia: 1,5 m
    canSwim = true,             -- Zdolność do pływania
    waterline_level = 1.2,      -- Poziom linii wodnej: 1,2 m
    ...
    engine_power = 543,         -- Moc silnika: 543 KM
    ...
    armour_thickness = 0.08,    -- Grubość pancerza: 80 mm
}

GT = {};
GT_t.ws = 0;
set_recursive_metatable(GT, GT_t.generic_wheel_vehicle);
set_recursive_metatable(GT.chassis, GT_t.CH_t.Rosomak);

GT.visual.shape = "Rosomak";
...
GT.Name = "Rosomak";
GT.DisplayName = _("IFV Rosomak");
GT.DisplayNameShort = _('Rosomak');
GT.Rate = 13;
