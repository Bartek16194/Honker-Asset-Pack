...
GT_t.CH_t.Tumak2 = {
    life = 3,
    mass = 2300,
    length = 4.515,  -- Długość w metrach
    width = 1.935,   -- Szerokość w metrach
    max_road_velocity = 100,  -- Maksymalna prędkość w km/h
    max_slope = 0.45,  -- Maksymalne nachylenie terenu
    fordingDepth = 0.8,  -- Głębokość brodzenia w metrach
    engine_power = 75,  -- Moc silnika w KM (wersja z silnikiem Iveco 2.5D)
    engineMinRPM = 750,
    ...
    min_turn_radius = 7.0,  -- Minimalny promień skrętu w metrach
    X_gear_1 = 1.60,
    Y_gear_1 = 0,
    Z_gear_1 = 0.70,
    X_gear_2 = -1.05,
...
set_recursive_metatable(GT.chassis, GT_t.CH_t.Tumak2);

GT.visual.shape = "tumak2";
GT.visual.shape_dstr = "tumak2-dest";
...
GT.Name = "tumak-2";
GT.DisplayName = _('LUV Tumak 2');
GT.DisplayNameShort = _('LUV Tumak 2');
GT.Rate = 5;
