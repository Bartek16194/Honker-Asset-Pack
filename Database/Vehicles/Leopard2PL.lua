GT_t.CH_t.LEO2PL = {
    life = 36,
    mass = 59500,  -- Masa bojowa w kilogramach
    length = 10.97,  -- Długość całkowita w metrach
    width = 3.75,   -- Szerokość w metrach
    max_road_velocity = 68,  -- Maksymalna prędkość na drodze w km/h
    max_slope = 0.6,  -- Maksymalne nachylenie terenu
    fordingDepth = 1.2,  -- Głębokość brodzenia w metrach
    engine_power = 1500,  -- Moc silnika w KM
    engineMinRPM = 600,
    ...
    max_vert_obstacle = 1.1,  -- Maksymalna wysokość przeszkody pionowej w metrach
    max_acceleration = 4.08497,
    min_turn_radius = 2.8,  -- Minimalny promień skrętu w metrach
    X_gear_1 = 2.91,
    Y_gear_1 = 0,
    Z_gear_1 = 1.53,
    X_gear_2 = -2.62,
